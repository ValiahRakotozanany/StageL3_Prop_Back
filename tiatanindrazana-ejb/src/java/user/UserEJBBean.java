...
public class UserEJBBean implements UserEJB {
    ...
    public Configuration[] getListeConfig() {
        return listeConfig;
    }
     ...
     * @throws Exception
     */
    public MapUtilisateurServiceDirection testeValide(String user, String pass) throws Exception {
        try {
            historique.UtilisateurUtil uI = new UtilisateurUtil();
            return (MapUtilisateurServiceDirection) uI.testeValide(user, pass);
        } catch (Exception ex) {
            ex.printStackTrace();
...
//    }
    ...
    public Configuration[] findConfiguration() throws Exception {
        ...
        try {
         //   c = new UtilDB().GetConn();
            Configuration[] liste = new Configuration[0]; //(Configuration[]) CGenUtil.rechercher(new Configuration(), null, null, c, " order by typeconfig desc");
            return liste;
        } catch (Exception e) {
            e.printStackTrace();
            throw e;
    ...
    public String findHomePageServices(String codeService) throws Exception {
        ...
        try {
            ...
            HomePageURL[] hommePageList = new HomePageURL[0];//(HomePageURL[]) CGenUtil.rechercher(new HomePageURL(), null, null, connection, " and idrole = '" + codeService + "'");
