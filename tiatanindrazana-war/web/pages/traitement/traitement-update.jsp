            ...
            <div class="box-fiche">
                <div class="box">
                    ...
                    <form action="<%=(String) session.getValue("lien")%>?but=apresTarif.jsp&id=<%out.print(request.getParameter("id"));%>" method="post">
                        ...
                        <input name="bute" type="hidden" id="bute" value="traitement/traitement-fiche.jsp">
                        <input name="classe" type="hidden" id="classe" value="map.TypeTraitement">
                        <input name="rajoutLien" type="hidden" id="rajoutLien" value="id-<%out.print(request.getParameter("id"));%>" >
                        <input name="nomtable" type="hidden" id="nomtable" value="type_traitement">
                    </form>
                </div>
            </div>
        </div>
