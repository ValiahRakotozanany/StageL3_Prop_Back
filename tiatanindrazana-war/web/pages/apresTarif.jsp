...
<html>
    ...
    <%
        ...
        try {
            ...
            if (acte.compareToIgnoreCase("insertMultipleMaladie") == 0 && request.getParameter("colonne") != null) {
                t = (ClassMAPTable) (Class.forName(classe).newInstance());
                PageInsert p = new PageInsert(t, request);
                System.out.println("colonne = " + request.getParameter("colonne"));
                IngredientMaladie f = (IngredientMaladie) p.getObjectAvecValeur();
                String colonne = request.getParameter("colonne");
                System.out.println("coollenneValuue = " + request.getParameter(colonne));
                String colonneValue = request.getParameter(colonne);
                String cv[] = colonneValue.split(";");
                f.dupliquerEtInserer(u.getUser().getTuppleID(), cv);
...
//                }else{%>
    ...
    <%
        ...
        if (t != null && t.getAttributIDName() != null && !t.getAttributIDName().trim().isEmpty()) {
            idAttributeName = t.getAttributIDName();
        }
    %>
