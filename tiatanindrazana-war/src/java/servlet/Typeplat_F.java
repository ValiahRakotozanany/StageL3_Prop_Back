...
import map.Proposition.Typeplat;

/**
 *
 * @author Valiah Karen
 */
@WebServlet(name = "Typeplat", urlPatterns = {"/Typeplat"})
public class Typeplat_F extends BaseWs {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Typeplat</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Typeplat at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            try {
                ...
                Typeplat t = new Typeplat();
                Typeplat[] mm = t.listeType( "typeplat", null);
