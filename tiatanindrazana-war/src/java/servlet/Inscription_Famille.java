 ...
 * @author Valiah Karen
 */
@WebServlet(name = "Inscription_Famille", urlPatterns = {"/Inscription_Famille"})
public class Inscription_Famille extends  BaseWs {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Inscription_Famille</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Inscription_Famille at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
        ...
        try (PrintWriter out = response.getWriter()) {
            try{
               ...
               // data = new Data(nomfamille);
                ...
                exc.printStackTrace();
                error = new Error(-2, "Situation", "Exception", exc.getMessage());
