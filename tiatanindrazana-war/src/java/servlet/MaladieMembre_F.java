...
public class MaladieMembre_F extends BaseWs {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            try {
                ...
                MaladieMembre[] mm = m.listeMaladieMembre(idmembre,"maladiemembre_lib", null);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       //String idmaladie = request.getParameter("idmaladie");
        String idmaladiemembre = request.getParameter("idmaladiemembre");
        String token = request.getHeader("Authorization");
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //    m.setIdMaladie(idmaladie);
                m.setId(idmaladiemembre);
                m.deleteMaladieMembre(idmaladiemembre, null);
